...
const (
	...
	StageGuardrailInput   Stage = "guardrail_input"
	StageGuardrailOutput  Stage = "guardrail_output"
	StageGuardrailBlocked Stage = "guardrail_blocked"
	StageGuardrailPassed  Stage = "guardrail_passed"
